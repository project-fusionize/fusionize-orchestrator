...
class OrchestrationInvocationResponseEventHandlerTest {
    ...
    @InjectMocks
    private OrchestrationInvocationResponseEventHandler handler;

    @Test
    void shouldHandle_whenAllConditionsMet() {
        // setup
        var event = spy(InvocationResponseEvent.builder(this)
    ...
    @Test
    void shouldCallOrchestratorOnInvoked() throws Exception {
        // setup
        var event = spy(InvocationResponseEvent.builder(this)
                .origin(OrchestrationEvent.Origin.RUNTIME_ENGINE)
                .build());
        ...
        verify(orchestrator).onInvoked(event);
    }
    ...
    void shouldReturnCorrectEventType() {
        ...
        // expectation
        Class<InvocationResponseEvent> eventType = handler.getEventType();

        // validation
        assertThat(eventType).isEqualTo(InvocationResponseEvent.class);
    }
}
